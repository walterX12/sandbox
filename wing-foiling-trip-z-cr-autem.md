# Wing Foiling Trip z ČR Autem - Kam v Květnu?

**Datum vytvoření:** 5. ledna 2026
**Téma:** Wing foiling destinace dostupné autem z ČR
**Zaměření:** Květen - Teplo + Zaručený vítr
**Obtížnost:** Střední (dlouhá cesta, ale super podmínky)

---

## 🌊 Úvod - Proč řešit wing foiling v květnu?

Květen je **ideální měsíc** pro wing foiling v jižní Evropě:
- ✅ **Teplo** (20-25°C vzduch, 18-22°C voda)
- ✅ **Stabilní termické větry** (odpolední garantovaný vítr)
- ✅ **Mimo hlavní sezónu** = levnější ubytování
- ✅ **Méně lidí** na vodě než v červenci/srpnu
- ✅ **Dlouhé dny** (západ slunce až kolem 20:00-21:00)

Pokud jste byli v **Tarifě a bylo to super**, máte štěstí - existuje několik podobně skvělých destinací!

---

## 🗺️ Top 4 Wing Foiling Destinace - Květen 2026

### 🏆 #1 TARIFA (Španělsko) - NEJLEPŠÍ PRO ZARUČENÝ VÍTR

**Reference: Tarifa byla super!** ✅

#### Proč Tarifa:
- 💨 **Vítr:** 90% dní fouká (Poniente nebo Levante) - **nejspolehlivější spot v Evropě**
- 🌡️ **Teplota v květnu:**
  - Vzduch: **22-26°C**
  - Voda: **18-20°C** (shorty nebo 3/2 wetsuit stačí)
- 🏖️ **Spoты:**
  - **Los Lances** - hlavní spot, flat water, ideální pro wing
  - **Valdevaqueros** - když fouká Poniente (západní vítr)
  - **Bolonia** - krásná pláž, méně lidí

#### Praktické info:
| Položka | Detail |
|---------|--------|
| **Vzdálenost z ČR** | ~2400 km (Praha) |
| **Čas jízdy** | 24-26 hodin (doporučuji 2 noci po cestě) |
| **Benzín (cesta tam i zpět)** | ~12 000 Kč (spotřeba 7L/100km, cena 1.5€/L) |
| **Mýtné** | ~4500 Kč (Francie, Španělsko) |
| **Celkem cesta** | **~16 500 Kč** |
| **Ubytování/noc** | 1200-3000 Kč (Airbnb/apartmán pro 2 osoby) |
| **Pronájem wing setup** | 1500-2000 Kč/den (wing + foil board + foil) |

#### Trasa z ČR:
```
Praha → Mnichov → Lyon → Narbonne → Barcelona → Valencia → Tarifa
(2400 km, 24h čisté jízdy)
```

**Doporučený program:**
- **1. noc:** Zastavit u Lyonu nebo Barcelony
- **2. noc:** Dojet do Tarify
- **Pobyt:** 7-10 dní wing foiling
- **Návrat:** 2 dny cesty zpět

#### Školy a pronájem:
- **Free Your Mind Tarifa** - czechy friendly, mluví anglicky/německy
- **Ion Club Tarifa** - pronájem, škola, skvělý vibe
- **Spin Out** - profesionální škola, wing kurzy
- **3Sixty Kite School** - mají wing foiling sekci

#### Kde bydlet:
- **Los Lances area** - blízko vody, dražší (2000-3000 Kč/noc)
- **Tarifa město** - levnější, 5-10 min autem na pláž (1200-2000 Kč/noc)
- **Camping** - ještě levnější, 600-1000 Kč/noc pro 2 osoby

---

### 🥈 #2 LEUCATE / LA FRANQUI (Francie) - DRUHÁ NEJLEPŠÍ VOLBA

**Pro: Blíž než Tarifa, podobné podmínky**

#### Proč Leucate:
- 💨 **Vítr:** 80% dní fouká **Tramontana** (severní vítr)
- 🌡️ **Teplota v květnu:**
  - Vzduch: **20-24°C**
...
| Položka | Detail |
|---------|--------|
| **Vzdálenost z ČR** | ~1600 km (Praha) |
| **Čas jízdy** | 16-18 hodin (1 noc po cestě) |
| **Benzín (tam i zpět)** | ~8000 Kč |
| **Mýtné** | ~3000 Kč (Francie) |
| **Celkem cesta** | **~11 000 Kč** |
| **Ubytování/noc** | 1500-2500 Kč (apartmán pro 2) |
| **Pronájem wing setup** | 1800-2200 Kč/den |

#### Trasa z ČR:
```
Praha → Mnichov → Lyon → Montpellier → Leucate
(1600 km, 16h čisté jízdy)
```
...
#### 🌍 CO DĚLAT v LEUCATE kromě Wing Foilingu/Windsurfingu

**Když nefouká (vzácné, ale možné):**

1. **Kite Surfing** (pokud umíte)
   - Leucate = legendary kite spot
   - Stejné školy jako wing foiling

2. **Stand Up Paddleboarding (SUP)**
   - Klidná laguna = ideální pro SUP
   - Pronájem: 20-30 €/den

3. **Klasické surfing**
   - **Leucate Plage** (na moři, ne laguna)
   - Při Tramontaně = velké vlny!
   - Surf školy: Leucate Surf Club

**Turistika & Příroda:**

4. **Cap Leucate** - Skalní útes s majákem
   - 🚶 15 min chůze od La Franqui
   - Úžasný výhled na Středozemní moře + Pyreneje
   - Západ slunce = must see! 🌅

5. **Les Coussoules Nature Reserve**
   - Chráněná oblast, ptactvo, divoká příroda
   - Krátké turistické trasy

6. **Corbières Wine Region** 🍷
   - 30 min autem = vinařská oblast
   - Degustace vín (Corbières AOC)
   - Návštěva vinařství (reservace online)

**Historické památky:**

7. **Château de Peyrepertuse**
   - 🏰 Středověký hrad na skále
   - 45 min autem od Leucate
   - Vstupné: ~8 €
   - Úžasný výhled!

8. **Carcassonne** - UNESCO město
   - 🏰 Největší pevnost v Evropě
   - 1 hodina autem
   - Denní výlet = must do!
   - Vstupné do citadely: 9.50 €

9. **Narbonne** - Římské město
   - 30 min autem
   - Katedrála, Římský Horreum
   - Nákupy, restaurace

**Jídlo & Večerní program:**

10. **Restaurace v La Franqui:**
    - **Chez Papé** - Mořské plody, fresh fish
    - **Le Prao** - Beach bar, burgery, pivo
    - **La Voile d'Or** - Pizza, pasta, french cuisine
    - **Cena:** 15-30 €/osoba

11. **Supermarket:**
    - **Intermarché Leucate** - 5 min autem (Av. de la Méditerranée)
    - **Otevřeno:** 8:30-19:30 (Ne do 12:30)
    - Pro vaření v camper vanu!

12. **Večerní vibe:**
    - Beach bary otevřené do 23:00+
    - Wing/kite komunita = friendly
    - Bonfire sessions na pláži (neoficiální)

**Relax & Wellness:**

13. **Pláž Bolonia** - Krásná divočejší pláž
    - 10 km od La Franqui
    - Méně lidí, čistá

14. **Spa/Masáže:**
    - Po 5 dnech wing foilingu = bolavé svaly!
    - **Thalasso Port Leucate** - Spa centrum
    - Masáž: 60-90 €/hod
...
**Wind Forecast - KDE sledovat vítr:**

1. ✅ **Windy.com** (nejlepší!)
   - 📍 Hledejte: "La Franqui"
   - Model: ECMWF (nejpřesnější pro Středomoří)
   - Sledujte: Wind speed, Wind gusts, Wave height

2. ✅ **Windguru.cz** (česky!)
   - 📍 La Franqui station
   - WG Model + GFS
   - Specialista na wind sports

3. ✅ **Windfinder.com**
   - 📍 Leucate spot
   - Statistiky větru (historická data)
   - Superforecast (placené, ale přesnější)

4. ✅ **Meteo France** (oficiální)
   - https://marine.meteofrance.com
   - Přesná lokální předpověď

**Jak číst forecast pro Leucate:**

- **Tramontana forecast:**
  - Směr: 330-360° (sever/severozápad)
  - Síla: 15-25 knots = ✅ Ideální!
  - Síla: 25-35 knots = ⚠️ Silný (pokročilí)
  - Síla: 35+ knots = ❌ Extrémní (nebezpečné!)

- **Marin (jižní vítr):**
  - Vzácný, ale možný
  - Offshore na La Franqui = NEBEZPEČNÉ!
  - Jděte na Leucate Plage (onshore)

**Nákupy & Služby:**

- **Benzínka:** Intermarché Leucate (levnější)
- **Lékárna:** Pharmacie Leucate, Av. du Roussillon
- **Lékař:** Cabinet Médical Leucate (emergency)
- **Police:** +33 4 68 40 01 30
- **Záchranná služba:** 112 (EU univerzální)

**WiFi & Mobilní data:**

- Camper parking: Většinou NE (nebo slabý)
- Restaurace/bary: Většina má WiFi
- Mobilní data: CZ operátoři = EU roaming ZDARMA!
  - O2, T-Mobile, Vodafone = funguje normálně

**Mluvíte Francouzsky?**

⚠️ V Leucate = **hlavně francouzsky**
- Školy: Angličtina OK
- Restaurace: Základní angličtina
- Místní: Francouzsky (málokdo anglicky)
...
### 🥉 #3 LAGO DI GARDA (Itálie) - NEJBLÍŽ, JEZERO

**Pro: Nejblíž z ČR, krásné jezero, termický vítr**

#### Proč Lago di Garda:
- 💨 **Vítr:** **Garantovaný termický vítr** odpoledne (Ora - jižní vítr)
  - **Ráno:** Peler (severní vítr) 8-15 knots
  - **Odpoledne:** Ora (jižní vítr) 12-20 knots
- 🌡️ **Teplota v květnu:**
  - Vzduch: **22-26°C** (super teplo!)
  - Voda: **16-18°C** (jezero = chladnější, 3/2 wetsuit nutnost)
- 🏖️ **Spoты:**
  - **Torbole** - hlavní wing/kite spot (severní konec)
  - **Malcesine** - krásné, méně lidí
  - **Campione** - menší spot, dobrý pro učení

#### Praktické info:
| Položka | Detail |
|---------|--------|
| **Vzdálenost z ČR** | ~800 km (Praha) |
| **Čas jízdy** | 8-9 hodin (1 den jízdy) |
| **Benzín (tam i zpět)** | ~4500 Kč |
| **Mýtné** | ~1500 Kč (Rakousko, Itálie) |
| **Celkem cesta** | **~6000 Kč** |
| **Ubytování/noc** | 2000-4000 Kč (dražší, turistická oblast) |
| **Pronájem wing setup** | 2000-2500 Kč/den (dražší než Španělsko) |

#### Trasa z ČR:
```
Praha → Linz → Innsbruck → Brenner Pass → Bolzano → Torbole
(800 km, 8-9h čisté jízdy)
```

**Výhoda:** Dá se dojet za 1 den!

#### Školy a pronájem:
- **Pier Windsurf Torbole** - wing foiling sekce, pronájem
- **Vasco Renna Watersports** - profesionální škola
- **Wind Action** - pronájem za rozumné ceny

#### ⚠️ Nevýhody:
- ❌ **Dražší** než Tarifa/Leucate (Itálie = vyšší ceny)
- ❌ **Vítr není 24/7** - hlavně odpoledne (12:00-18:00)
- ❌ **Studená voda** (16-18°C = musíte mít wetsuit)
- ❌ **Plné turistů** v květnu (vysoká sezóna)

---

### 🌴 #4 VIGANJ - PELJEŠAC (Chorvatsko) - LEVNĚJŠÍ ALTERNATIVA

**Pro: Blízko, levné, teplé, dobrý vítr**

#### Proč Viganj:
- 💨 **Vítr:** **Maestral** (severozápadní termický vítr) - 70% dní
- 🌡️ **Teplota v květnu:**
  - Vzduch: **23-27°C**
  - Voda: **19-21°C** (shorty často stačí!)
- 🏖️ **Spoты:**
  - **Viganj** - hlavní wing/kite spot
  - **Kučište** - menší, klidnější
  - Korčula island - krásná scenérie

#### Praktické info:
| Položka | Detail |
|---------|--------|
| **Vzdálenost z ČR** | ~1100 km (Praha) |
| **Čas jízdy** | 11-13 hodin (1 noc doporučuji) |
| **Benzín (tam i zpět)** | ~5500 Kč |
| **Mýtné** | ~1200 Kč (Slovinsko, Chorvatsko) |
| **Celkem cesta** | **~6700 Kč** |
| **Ubytování/noc** | 800-1800 Kč (LEVNÉ!) |
| **Pronájem wing setup** | 1200-1800 Kč/den (levnější než Itálie) |

#### Trasa z ČR:
```
Praha → Vídeň → Graz → Ljubljana → Rijeka → Split → Viganj
...
## 💰 Srovnání Celkových Nákladů (10 dní trip pro 2 osoby)

| Destinace | Cesta | Ubytování (9 nocí) | Pronájem wing (6 dní) | **CELKEM** |
|-----------|-------|-------------------|----------------------|-----------|
| **Tarifa** | 16 500 Kč | 18 000 Kč | 10 000 Kč | **44 500 Kč** |
| **Leucate** | 11 000 Kč | 15 000 Kč | 11 000 Kč | **37 000 Kč** |
| **Lago di Garda** | 6 000 Kč | 27 000 Kč | 13 000 Kč | **46 000 Kč** |
| **Viganj** | 6 700 Kč | 10 000 Kč | 9 000 Kč | **25 700 Kč** |

**Poznámky:**
- Ceny jsou pro **2 osoby celkem**
- Nezahrnuje jídlo, pivo, zmrzlinu 😊
- Wing pronájem = pokud nemáte vlastní gear
- Pokud máte **vlastní wing setup** = ušetříte 9-13 tisíc!
...
**Kdy jet:**
- ✅ Když chcete **maximální jistotu** větru
- ✅ Když máte čas (7-10 dní + cesta)
- ✅ Když nechcete riskovat "bez větru" týden
- ✅ Když milujete moře a surfing vibe

**Nevýhody:**
- ❌ Nejdelší cesta (2 dny tam, 2 dny zpět)
- ❌ Dražší benzín a mýtné

---

### Pro kompromis cesta/vítr → **LEUCATE** 🥈
**Kdy jet:**
- ✅ Když chcete dobrý vítr, ale kratší cestu
- ✅ Když máte jen 7-8 dní celkem
- ✅ Když Tarifa je moc daleko

---

### Pro víkendový trip → **LAGO DI GARDA** 🥉
**Kdy jet:**
- ✅ Když máte jen **prodloužený víkend** (4-5 dní)
- ✅ Když chcete krásnou přírodu + wing foiling
- ✅ Když nechcete dlouhou cestu

**Nevýhody:**
- ❌ Vítr jen odpoledne (ráno slabý)
- ❌ Dražší ubytování
- ❌ Studená voda (wetsuit nutnost)

---

### Pro levnou dovolenou → **VIGANJ** 🌴
**Kdy jet:**
- ✅ Když chcete **ušetřit** (nejlevnější!)
- ✅ Když chcete teplo + moře
- ✅ Když chcete klidnější atmosféru než Tarifa

**Nevýhody:**
- ❌ Vítr není 100% garantovaný (70%)
- ❌ Maestral fouká hlavně odpoledne

---

## 🧳 Co s sebou - Checklist

### Wing Foiling Gear:
- ✅ **Wing** (nebo pronájem na místě)
- ✅ **Foil board + foil** (nebo pronájem)
- ✅ **Wetsuit:**
  - Tarifa/Leucate: 3/2mm nebo shorty (18-20°C voda)
  - Lago di Garda: 3/2mm nebo 4/3mm (16-18°C studené!)
  - Viganj: Shorty nebo 3/2mm (19-21°C)
- ✅ **Impact vest** (doporučuji, bezpečnost)
- ✅ **Helmet** (kameny, lidi, desky...)
- ✅ **Booties** - obzvlášť Lago di Garda (kamenité dno)

### Auto Essentials:
- ✅ **Dálniční známky:**
  - Rakousko: 10-day vignette (~300 Kč)
  - Slovinsko: týdenní (~15 €)
  - Chorvatsko: není potřeba (ale mýtné na dálnicích)
- ✅ **Reflexní vesty** (povinné v autě)
- ✅ **Trojúhelník** (povinný)
- ✅ **Náhradní žárovky**
- ✅ **Střešní nosiče** nebo velký vůz (wing + boardy zabírají místo!)

### Ostatní:
- ✅ **Rezervy benzínu** - plánujte zastávky
- ✅ **Dobíječka do auta** (telefon, kamery)
- ✅ **Kamera** (GoPro, DJI Osmo) - chcete to natočit! 🎥
- ✅ **Opalovací krém** (na vodě se spálíte rychle)

---

## 🚗 Tipy Pro Cestu Autem

### Plánování:
1. ✅ **Dva řidiči** - střídejte se každé 2-3 hodiny
2. ✅ **Noc po cestě** - nechoďte na 24h non-stop (nebezpečné!)
3. ✅ **Google Maps + offline mapy** - stahněte předem
4. ✅ **Tankování:**
   - V Rakousku/Německu = dražší (1.6-1.8 €/L)
   - Ve Španělsku = levnější (1.4-1.5 €/L)
   - Tip: Tankujte před hranicemi!

### Zastávky po cestě (Tarifa route):
- **1. noc:** Lyon (Francie) nebo Barcelona (Španělsko)
  - Lyon: ~1000 km z Prahy (10h jízdy)
  - Barcelona: ~1600 km z Prahy (16h jízdy)
- **2. den:** Dojeďte do Tarify (800 km, 8h)

### Kam se vyhnout:
- ❌ **Pátek odpoledne** - zácpy z měst
- ❌ **Neděle večer** - návrat z víkendu
- ❌ **Svátky** - plné dálnice

---

## 🌬️ Vítr v Květnu - Statistiky

### Tarifa:
- **90% dní** vítr 15+ knots
- **Poniente** (západní): gentle, 15-25 knots
- **Levante** (východní): silnější, 20-35 knots, vlny
- **Nejlepší:** Poniente pro wing foiling (flat water)

### Leucate:
- **80% dní** vítr 12+ knots
- **Tramontana:** severní, 15-30 knots, reliable
- **Odpoledne:** téměř vždy vítr díky termice

### Lago di Garda:
- **Ráno:** Peler (severní) 8:00-12:00, 10-15 knots
- **Odpoledne:** Ora (jižní) 12:00-18:00, 12-20 knots
- **Nejlepší:** 13:00-16:00 peak vítr

### Viganj:
- **70% dní** vítr 12+ knots
- **Maestral:** odpoledne, 13:00-18:00, 15-25 knots
- **Bura:** silný severovýchodní, ale vzácný v květnu
...
### Vítr & Počasí:
- ✅ **Windy.com** - nejlepší forecast, live wind
- ✅ **Windfinder** - detailní statistiky spotů
- ✅ **Windguru** - další forecast, pro srovnání

### Navigace:
- ✅ **Google Maps** - offline mapy!
- ✅ **Waze** - varování před policií, zácpy

### Ubytování:
- ✅ **Airbnb** - apartmány, levnější pro skupiny
- ✅ **Booking.com** - hotel, někdy lepší last minute

### Wing Foiling Komunita:
- ✅ **Facebook Groups:**
  - "Wing Foiling Europe"
  - "Tarifa Wing Foilers"
  - "Wing Foiling Czech/Slovakia" (české komunita!)
- ✅ **Instagram:** #wingfoiling #tarifa #leucate
...
### Na Vodě:
- ✅ **Nošte helmet + impact vest** - foil je nebezpečný!
- ✅ **Leash:** Používejte **quick-release** leash (ne pevný!)
- ✅ **Znalost práva přednosti:** Wing = jako kite (vyhýbáme se surfařům)
- ✅ **Offshore vítr:** POZOR! Odnese vás ven (hlavně začátečníci)

### V Autě:
- ✅ **Reflexní vesta** - povinná (každá osoba v autě)
- ✅ **Dálniční známky** - kontroly! Pokuta = 120-300 €
- ✅ **Rychlost:**
  - Německo: dálnice často bez limitu (buďte opatrní!)
  - Rakousko: 130 km/h
  - Španělsko: 120 km/h
  - Itálie: 130 km/h

### Zdraví:
- ✅ **EHIC karta** (Evropský zdravotní průkaz) - zdarma u pojišťovny
- ✅ **Cestovní pojištění** - doporučuji pro sport + auto
- ✅ **Léky:** Ibuprofen, Paralen (unavené svaly 😊)

---

## 🤔 FAQ - Často Kladené Otázky

### Q: Mám vlastní wing setup. Ušetřím hodně?
**A:** **ANO!** Ušetříte **9 000-13 000 Kč** za pronájem (viz tabulka). Vlastní gear = největší úspora!

### Q: Stačí 5 dní na trip?
**A:** Záleží na destinaci:
- ✅ **Lago di Garda:** ANO (1 den tam, 3 dny wing, 1 den zpět)
- ❌ **Tarifa:** NE (cesta = 4 dny, zbyde jen 1 den wing!)
- ⚠️ **Leucate/Viganj:** Možné, ale krátké (2 dny cesta, 3 dny wing)

### Q: Kdy je v Tarifě nejvíc větru?
**A:** **Květen-září** = peak season. Červenec/Srpen = nejvíc větru, ale plné lidi. **Květen = skvělý kompromis!**

### Q: Musím umět wing foiling předem?
**A:** Doporučuji:
- ✅ **Ideální:** Umíte alespoň wing ovládat + základy foilingu
- ⚠️ **Možné:** Absolvovat kurz na místě (3-5 dní, ~15 000 Kč)
- ❌ **Nedoporučuji:** Jet bez zkušeností a čekat zázrak

### Q: Co když nebude foukat?
**A:**
- **Tarifa:** 90% dní = téměř vždy vítr. Pokud ne = surf, kiteboarding, vypadněte do Gibraltaru
- **Leucate:** 80% = dobré odds. Backup: Surf, Montpellier city trip
- **Lago di Garda:** Termika = velmi reliable. Backup: Via ferrata, hiking
- **Viganj:** 70% = někdy bez větru. Backup: Ostrov Korčula, Dubrovník (1h autem)

### Q: Můžu jet sám (solo trip)?
**A:** Můžete, ale:
- ❌ **Nevýhoda:** Střídání řidičů = nemáte (náročná cesta)
- ❌ **Dražší:** Ubytování pro 1 osobu = dražší per capita
- ✅ **Výhoda:** Svoboda, žádné kompromisy, lehčí najít komunitu na místě

### Q: Wing foiling vs. kiteboarding - co je lepší?
**A:** **Wing foiling** má několik výhod:
- ✅ Jednodušší setup (bez baru, lanek, velký kite)
- ✅ Lehčí transportovat (wing = sbalený malý)
- ✅ Bezpečnější (žádné linky, menší wing)
- ✅ **Trendy** = všude více a více wingers!

---

## 🎯 Finální Doporučení - Co Bych Udělal Já

**Pokud jste byli v Tarifě a bylo to super:**

### Varianta A: Zpět do Tarify ✅
**Proč:** Už znáte spot, víte že to milujete, vítr garantovaný.
**Kdy:** Květen nebo Červen (Červenec/Srpen = plné turistů)
**Budget:** ~45 000 Kč pro 2 osoby (10 dní)

### Varianta B: Zkusit Leucate (nový zážitek)
**Proč:** Podobné Tarifě, ale kratší cesta, jiný vibe.
**Kdy:** Květen
**Budget:** ~37 000 Kč pro 2 osoby (10 dní)

### Varianta C: Krátký Viganj trip (levný testovák)
**Proč:** Levné, blízko, otestovat nový spot.
**Kdy:** Květen nebo Září
**Budget:** ~26 000 Kč pro 2 osoby (10 dní)

---

## ✅ Akční Plán - Jak Začít

### Týden 1-2: Plánování
1. ✅ **Rozhodnout destinaci** (Tarifa/Leucate/Garda/Viganj)
2. ✅ **Najít parťáka** (sdílení nákladů + střídání řidičů)
3. ✅ **Rezervovat ubytování** (Airbnb, Booking.com)
4. ✅ **Rezervovat pronájem wing** (pokud nemáte vlastní)

### Týden 3-4: Příprava
1. ✅ **Auto servis** (kontrola, olej, pneumatiky)
2. ✅ **Koupit dálniční známky** (Rakousko, Slovinsko)
3. ✅ **Zabalit gear** (wetsuit, helmet, vest, booties)
4. ✅ **Stáhnout offline mapy** (Google Maps)

### Týden před odjezdem:
1. ✅ **Sledovat forecast** (Windy.com, Windguru)
2. ✅ **Naplánovat zastávky** (noc po cestě, tankování)
3. ✅ **Zabalit auto** (gear, jídlo, voda na cestu)

### Den D:
🚗💨 **JEĎTE A UŽÍVEJTE SI TO!** 🌊🪁

---

## 📊 Rychlé Srovnání - Tabulka

| Spot | Vítr % | Vzdálenost | Cesta | Celkem (10d/2os) | Voda °C | Nejlepší pro |
|------|--------|------------|-------|------------------|---------|--------------|
| **Tarifa** | 90% | 2400 km | 16 500 Kč | 44 500 Kč | 18-20°C | Garantovaný vítr |
| **Leucate** | 80% | 1600 km | 11 000 Kč | 37 000 Kč | 17-19°C | Kompromis cesta/vítr |
| **Lago di Garda** | 85%* | 800 km | 6 000 Kč | 46 000 Kč | 16-18°C | Krátký trip |
| **Viganj** | 70% | 1100 km | 6 700 Kč | 25 700 Kč | 19-21°C | Levná dovolená |

*Termický vítr = reliable odpoledne, ale jen odpoledne!

---

## 🏆 Závěr

**Wing foiling trip z ČR autem = REÁLNÉ a SKVĚLÉ!**

Klíčové body:
- 🌊 **Tarifa** = nejlepší vítr (90%), ale nejdelší cesta
- 💨 **Leucate** = dobrý kompromis (80% vítr, kratší cesta)
- 🏔️ **Lago di Garda** = víkendový trip, krásné jezero
- 💰 **Viganj** = nejlevnější, pořád dobrý vítr (70%)

**Moje osobní rada:**
Pokud máte **7-10 dní** a chcete si být **100% jistí větrem** → **TARIFA** 🏆

Pokud máte **5-7 dní** a chcete kompromis → **LEUCATE** 🥈

Pokud máte **jen víkend** → **LAGO DI GARDA** 🥉

Pokud chcete **ušetřit** → **VIGANJ** 🌴

---

**Užijte si wing foiling! Tarifa byla super, další destinace budou taky! 🪁🌊**

---

*Poslední aktualizace: 5. ledna 2026*
*Reference: Tarifa trip - květen 2025 ✅*
