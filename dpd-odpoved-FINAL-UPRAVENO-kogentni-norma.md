...
děkuji za Váš email ze dne 11. února 2026 a za nabídku kompenzace
ve výši 2 500 Kč.

Po pečlivém zvážení Vaší nabídky musím bohužel sdělit, že s touto
částkou nemohu souhlasit. Dovolte mi vysvětlit proč:


═══════════════════════════════════════════════════════════════════
JAK TO CELÉ VIDÍM JÁ - BĚŽNÝ ČLOVĚK, KTERÝ POTŘEBOVAL VYTOPIT DŮM
═══════════════════════════════════════════════════════════════════
...
a) **Hledání náhradního ventilátoru (14.1.2026 ráno)**
...
c) **Montáž ventilátoru**
   ...
   → Montáž by stála cca 2 000 Kč
   → Provedl jsem ji sám (ušetřil jsem DPD 2 000 Kč)
   → **NEUPLATŇUJI NÁROK NA MONTÁŽ**


d) **Doprava DPD (nerealizovaná služba)**

   → Za dopravu ventilátoru k opravě jsem DPD zaplatil: **100 Kč**
...
Píšete, že ventilátor podléhá amortizaci kvůli stáří (2007).
...
c) **Výzva k DPD:**
   ...
   Pokud to NEDOKÁŽETE → pak 2 500 Kč nekryje skutečnou škodu


6. CO OD VÁS OČEKÁVÁM
...
**TOTO JE KLÍČOVÉ - PŘEČTĚTE SI POZORNĚ:**

1. Co říká zákon

Podle § 2925 odst. 1 zákona č. 89/2012 Sb., občanského zákoníku:

"Dopravce odpovídá za škodu vzniklou **ztrátou** nebo **poškozením**
věci od jejího převzetí do jejího vydání."
...
**§ 2912 odst. 1 OZ výslovně říká:**

"**Nemůže-li se každý dopravce podle jiného právního předpisu
odpovědnosti zprostit**, je jeho odpovědnost upravena následujícími
ustanoveními."

**Co to znamená v češtině:**

→ § 2912-2925 OZ jsou **KOGENTNÍ**
→ Dopravce **NEMŮŽE** svou odpovědnost:
   - Vyloučit úplně ("neodpovídám za ztrátu")
   - Omezit pod zákonný rámec ("odpovídám jen do 2 500 Kč")
   - Změnit podmínky odpovědnosti proti zákonu

→ **POKUD TO VOP DĚLÁ → VOP JE NEPLATNÉ**
...
```
ZÁKON (kogentní § 2925 OZ):  "Dopravce ODPOVÍDÁ za škodu"
                             "Uhraďte SKUTEČNOU škodu"
               VS
...
**§ 2952 OZ říká:**
"Náhrada škody zahrnuje, co **bylo SKUTEČNĚ vynaloženo**"
...
a) **Soud VŽDY použije zákon místo VOP**

   Pokud to půjde k soudu:
   → Soud si přečte § 2912 OZ ("nemůže-li se odpovědnosti zprostit")
...
b) **Česká obchodní inspekce (ČOI) zakáže takové VOP**

   → ČOI může nařídit DPD ODSTRANIT amortizační doložku z VOP
   → ČOI může uložit POKUTU za nepřiměřené smluvní podmínky
...
**Podle § 2912 OZ:**
→ § 2925 OZ je KOGENTNÍ
→ VOP DPD NEMŮŽE omezit odpovědnost dopravce
→ Pokud to VOP dělá → VOP je NEPLATNÉ

**Podle § 2952 OZ:**
→ Náhrada = SKUTEČNĚ vynaložené náklady
→ NIKOLIV "amortizovaná hodnota" podle VOP
...
1. Odkaz na oddíl 3.5 Reklamačního řádu DPD

Odkazujete na oddíl 3.5 Reklamačního řádu, který stanoví:

"V případě vzniku škody u starší věci (např. elektronika, výpočetní
technika apod.) nebo použité či opotřebené věci, která je obsahem
poškozené Zásilky, se skutečná hodnota věci v době přepravy odvíjí
od stáří poškozené věci a jejího opotřebení."

Toto ustanovení se však na můj případ NEVZTAHUJE z následujících důvodů:

a) **Ventilátor nebyl "opotřebený nefunkční díl"**

   Oddíl 3.5 Reklamačního řádu hovoří o "opotřebené věci".
   ...
   Analogie:
   → Auto z roku 2007 má prasklé čelo motoru
   → Oprava čela motoru: 5 000 Kč
   → Auto po opravě pojede jako nové
   → Není to "opotřebené auto na odpis" - je to OPRAVITELNÁ závada
...
III. § 2952 OZ - NÁSLEDNÁ ŠKODA (SKUTEČNÉ NÁKLADY)

Podle § 2952 odst. 1 zákona č. 89/2012 Sb., občanského zákoníku:

"Náhrada za ztrátu na výdělku a za ztrátu vyhlídky na výdělek
v budoucnosti zahrnuje, co **bylo vynaloženo** v souvislosti
se škodnou událostí..."
...
Zákon vyžaduje náhradu SKUTEČNĚ VYNALOŽENÝCH nákladů, nikoliv
"amortizované hodnoty" ztracené věci.


IV. § 2002 OZ - VRÁCENÍ PENĚZ ZA NEREALIZOVANOU SLUŽBU

Podle § 2002 zákona č. 89/2012 Sb., občanského zákoníku:

"Strana, která nesplnila svůj závazek, **vrátí** to, co přijala
jako plnění smlouvy."

V mém případě:
→ Zaplatil jsem DPD 100 Kč za dopravu ventilátoru k opravě
→ DPD však dopravu **NEREALIZOVALO** (zásilka ztracena)
→ DPD má povinnost vrátit 100 Kč

**Požaduji vrácení 100 Kč za nerealizovanou službu.**


V. URGENTNÍ SITUACE ODŮVODŇOVALA NÁKUP NOVÉHO DÍLU
...
Nemohl jsem být nucen:
→ Čekat na vyřízení reklamace (30 dnů) v mrazu
→ Hledat "použitý díl za 2 500 Kč" (který na trhu NEEXISTUJE)
→ Riskovat zdraví rodiny a poškození majetku (zamrznutí topení)

Urgentní nákup NOVÉHO dílu byl za daných okolností JEDINÝM
rozumným řešením a DPD musí uhradit náklady s tím spojené
(§ 2952 OZ).


VI. NEMOŽNOST ZAKOUPIT NÁHRADNÍ DÍL ZA 2 500 KČ

1. Skutkový stav trhu (14.1.2026)
...
Podle § 1925 odst. 2 zákona č. 89/2012 Sb., občanského zákoníku:

"Prodlení s vyřízením reklamace nad třicet dnů je považováno
...
1. **Podání podnětu na Českou obchodní inspekci (ČOI)**
   ...
   Důvody:
   → Nevyřízení reklamace v zákonné lhůtě (§ 1925 OZ)
   → Nepřiměřené omezení odpovědnosti smluvními podmínkami
     (§ 1726 OZ)
   → Odmítnutí náhrady škody v rozporu s § 2925 a § 2952 OZ
   → **Použití NEPLATNÉHO ustanovení VOP** (§ 2912 OZ - kogentní norma)

   Kontakt ČOI:
   → Web: https://www.coi.cz/informace-pro-spotrebitele/podani-podnetu/
   → Tel: 296 366 360
...
2. **Podání žaloby o náhradu škody k příslušnému soudu**
   ...
   → § 2925 OZ (odpovědnost dopravce - kogentní)
   → § 2952 OZ (následná škoda - skutečné náklady)
   → § 2002 OZ (vrácení peněz za nerealizovanou službu)
   → § 1925 OZ (prodlení s vyřízením reklamace)
   → § 1726 OZ (neplatnost nepřiměřených podmínek)

   Argumentace:
   → **VOP DPD je v rozporu s KOGENTNÍ normou § 2925 OZ**
   → **Podle § 2912 OZ NELZE odpovědnost dopravce smluvně omezit**
   → Protiprávní aplikace amortizační doložky VOP DPD
   → Ventilátor nebyl "opotřebený" - byl OPRAVITELNÝ (hodnota 1500 Kč)
   → Amortizace se nevztahuje na následnou škodu (§ 2952 OZ)
...
❌ Je v rozporu s § 2952 OZ (následná škoda - skutečné náklady)
❌ Je v rozporu s § 2925 OZ (kogentní odpovědnost - NELZE omezit VOP)
❌ Je v rozporu s § 2912 OZ (VOP nemůže omezit odpovědnost dopravce)
❌ Je nepřiměřeným zkrácením práv (§ 1726 OZ - neplatné ujednání)
